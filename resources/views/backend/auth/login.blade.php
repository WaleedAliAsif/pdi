                          ...
                          <div class="sign-in-detail text-white">
                            <a class="sign-in-logo mb-5" href="#"><img src="{{asset('backend/images/fs_logo.png')}}" class="img-fluid" alt="logo"></a>
                              <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="1" data-items-laptop="1" data-items-tab="1" data-items-mobile="1" data-items-mobile-sm="1" data-margin="0">
                                  <div class="item">
                                      <img style="border:3px solid white;"  src="{{asset('backend/images/login/1.gif')}}" class="img-fluid mb-4" alt="logo">
                                      <h4 class="mb-1 text-white">Doctors can manage Pateint History</h4>
                                      <p>It is a benefit for All the doctors that it is providing Result history for Pateints.</p>
                                  </div>
                                  <div class="item">
                                      <img style="border:3px solid white;"  src="{{asset('backend/images/login/12.gif')}}" class="img-fluid mb-4" alt="logo"> 
                                      <h4 class="mb-1 text-white">Cloud Base Parkinson Disease Identifier on Big Data</h4>
                                      <p>Login to Explore the world of Artificial intelligence in neuroimaging</p>
                                  </div>
                                  <div class="item" >
                                      <img style="border:3px solid white; width:400px;height:400px;" src="{{asset('backend/images/login/13.gif')}}" class="img-fluid mb-4" alt="logo">
                                      <h4 class="mb-1 text-white">Create new Detections</h4>
                                      <p>It is very convinient to detect parkinson with the help of Deep learning.</p>
                                  </div>
                              </div>
                          </div>
                      </div>
